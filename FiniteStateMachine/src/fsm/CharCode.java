	...
	public CharCode(String str) {
		...
		case 2: 
			...
			case '"':
				...
				break;
			case 'n':
				specialChar = 'n';			// Use the new line (CR) character
				break;
			case 'l':
				specialChar = 'l';			// Use the line feed (LF) character
				break;
			case 'b':
				specialChar = 'b';			// Use the blank character
				break;
			case 't':
				specialChar = 't';			// Use the tab character
				break;
			default: 
